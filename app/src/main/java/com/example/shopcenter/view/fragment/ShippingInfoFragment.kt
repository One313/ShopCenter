...
import com.example.shopcenter.data.model.customer.Shipping
import com.example.shopcenter.databinding.FragmentShippingInfoBinding
...
class ShippingInfoFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewModel.getIsPostCustomerLiveData().observe(this, Observer {
            if (it) {
                mViewModel.insert(com.example.shopcenter.data.database.entity.Customer(mFirstName, mLastName, mEmail))
